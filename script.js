...
// myCode
const myFunction = () => {
  const url = "https://api.github.com/users/Josenunez20";
...
window.onload = function() {
  document.getElementById('contact-form').addEventListener('submit', function(event) {
    ...
    // Verifica que los campos no estén vacíos antes de enviar
    if (!name || !email) {
    ...
    emailjs.sendForm('service_h770ytu', 'template_c2qj413', this)
      .then(() => {
        // Mostrar mensaje con los datos enviados
...
function cargarDatos() {
  let url = "https://api.github.com/users/Josenunez20/repos";
  let jobs;
